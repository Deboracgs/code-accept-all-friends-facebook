javascript: void(function () {
  ...
  window.aing = {
    uid: uid,
    loding: {
      img: "<img src=\"//i.redd.it/6eqdnsnk9vwx.gif\" width=\"16px\" height=\"11px\" style=\"margin:0 5px;vertical-align:bottom\"/>",
    ...
    klos: function (waw) {
      ...
      aing.kolAjak("/ajax/friends/lists/subscribe/modify", aing.ajax.requestsLoader().prm + "&location=permalink&action=subscribe&flid=780835668601841", "", function () {
